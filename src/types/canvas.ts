/**
 * Canvas file type definitions for Obsidian Canvas support
 * Based on the official Obsidian Canvas format specification
 */
...
/**
 * Parsed canvas content for task extraction
 */
export interface ParsedCanvasContent {
    /** The original canvas data */
    canvasData: CanvasData;
    /** Text content extracted from text nodes */
    textContent: string;
    /** Individual text nodes for more granular processing */
    textNodes: CanvasTextData[];
    /** File path of the canvas */
    filePath: string;
}

/**
 * Canvas parsing options
 */
export interface CanvasParsingOptions {
    /** Whether to include node IDs in the extracted text */
    includeNodeIds?: boolean;
    /** Whether to include node positions as metadata */
    includePositions?: boolean;
    /** Custom separator between text nodes */
    nodeSeparator?: string;
    /** Whether to preserve line breaks within nodes */
